...
class CandidateAdmin(admin.ModelAdmin):
    form = CandidateForm
    readonly_fields = ('created_on', 'first_name', 'last_name', 'email', 'age', 'job', 'salary', 'gender', 'smoker', 'resume', 'messages', 'languages', 'frameworks', 'databases', 'libraries', 'mobile', 'other', 'personality', 'experience', 'phone',)
    exclude = ('status',)
